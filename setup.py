...
setup(
    name='pymulticonsensus',
    version='0.1',
    author='Daniel Barath, Denys Rozumny, Ivan Eichhardt, Levente Hajder, Jiri Matas',
    author_email='majti89@gmail.com',
    description='Multi Consensus Fitting',
    long_description='',
    packages=find_packages('src'),
    package_dir={'':'src'},
    ext_modules=[CMakeExtension('pymulticonsensus/pymulticonsensus')],
